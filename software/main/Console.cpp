...
static void console_task(void *this_ptr)
{
    initialize_nvs();
    ...
    ESP_LOGE(Console::TAG, "Error or end-of-input, terminating console");
    esp_console_deinit();
}

const char* Console::TAG = "Console";
...
void Console::init()
{
    xTaskCreate(console_task, "console_task", configMINIMAL_STACK_SIZE * 4, this, 5, NULL);
